              ...
              <div class="card-body">
                ...
                <table class="table table-bordered">
                  <thead>
                    <tr>
                      <th scope="col">#</th>
                      <th scope="col" class="w-25"><span>النوع</span></th>
                      <th scope="col" class="w-25"><span>الوزن</span></th>
                      <th scope="col" class="w-25"><span>السعر</span></th>
                      <th class="w-50" scope="col"><span>صورة الصنف</span></th>
